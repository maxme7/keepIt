...
document.querySelectorAll("tr[data-dz-ui='dictentry:showInfobox']")

let entries = document.querySelectorAll("tr[data-dz-ui='dictentry:showInfobox']")
for(let entry of entries){
    let left = entry.querySelectorAll("td[class='wb-bw']")[0]
    let right = entry.querySelectorAll("td[class='wb-bw']")[1]
